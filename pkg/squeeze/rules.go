...
func AllRules() map[string]Rule {
	return map[string]Rule{
		...
		"row_policy_missing":                   ruleRowPolicyMissing,
		"row_policy_unknown_identity":          ruleRowPolicyUnknownIdentity,
		"row_policy_unlowerable":               ruleRowPolicyUnlowerable,
		"row_policy_context_missing":           ruleRowPolicyContextMissing,
		"row_policy_context_spoof":             ruleRowPolicyContextSpoof,
		"row_policy_bypass":                    ruleRowPolicyBypass,
		"row_policy_projection_conflict":       ruleRowPolicyProjectionConflict,
		"row_policy_application_only":          ruleRowPolicyApplicationOnly,
		"rls_not_enabled":                      ruleRLSNotEnabled,
		"rls_not_forced":                       ruleRLSNotForced,
		"rls_runtime_bypass":                   ruleRLSRuntimeBypass,
		"rls_manual_broadening":                ruleRLSManualBroadening,
		"rls_drift":                            ruleRLSDrift,
