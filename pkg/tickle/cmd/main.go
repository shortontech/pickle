...
var templates = []struct {
...
}{
	{
		...
		skip:   map[string]bool{"query.go": true, "query_immutable.go": true, "scopes.go": true, "config.go": true, "transaction.go": true, "errors.go": true, "locks.go": true, "integrity.go": true, "merkle.go": true},
	},
	{
		srcDir: "pkg/cooked",
