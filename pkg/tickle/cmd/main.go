...
var templates = []struct {
	...
	},
	{
		...
		only:   map[string]bool{"query.go": true, "query_immutable.go": true, "connection.go": true, "transaction.go": true, "errors.go": true, "locks.go": true, "integrity.go": true, "merkle.go": true, "encryption.go": true},
	},
	{
		srcDir: "pkg/cooked",
